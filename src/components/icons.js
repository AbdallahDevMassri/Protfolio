...
export const InstagramIcon = ({ className, ...rest }) => (
  ...
  >
    ...
    <path
      fill="#E4405F"
      d="M12 2.163c3.204 0 3.584.012 4.85.07 1.17.056 1.97.246 2.41.41a4.9 4.9 0 011.675.976 4.9 4.9 0 01.976 1.675c.163.44.354 1.24.41 2.41.058 1.266.07 1.646.07 4.85s-.012 3.584-.07 4.85c-.056 1.17-.246 1.97-.41 2.41a4.9 4.9 0 01-.976 1.675 4.9 4.9 0 01-1.675.976c-.44.163-1.24.354-2.41.41-1.266.058-1.646.07-4.85.07s-3.584-.012-4.85-.07c-1.17-.056-1.97-.246-2.41-.41a4.9 4.9 0 01-1.675-.976 4.9 4.9 0 01-.976-1.675c-.163-.44-.354-1.24-.41-2.41-.058-1.266-.07-1.646-.07-4.85s.012-3.584.07-4.85c.056-1.17.246-1.97.41-2.41a4.9 4.9 0 01.976-1.675 4.9 4.9 0 011.675-.976c.44-.163 1.24-.354 2.41-.41 1.266-.058 1.646-.07 4.85-.07zm0-2.163C8.756 0 8.344 0 7.052.07c-1.297.06-2.184.263-2.96.555a7.62 7.62 0 00-2.734 1.645A7.62 7.62 0 00.907 4.645c-.292.776-.495 1.663-.555 2.96C.27 8.344.27 8.756.27 12s0 3.656.07 4.948c.06 1.297.263 2.184.555 2.96a7.62 7.62 0 001.645 2.734 7.62 7.62 0 002.734 1.645c.776.292 1.663.495 2.96.555 1.292.07 1.704.07 5.948.07s3.656 0 4.948-.07c1.297-.06 2.184-.263 2.96-.555a7.62 7.62 0 002.734-1.645 7.62 7.62 0 001.645-2.734c.292-.776.495-1.663.555-2.96.07-1.292.07-1.704.07-5.948s0-3.656-.07-4.948c-.06-1.297-.263-2.184-.555-2.96a7.62 7.62 0 00-1.645-2.734A7.62 7.62 0 0020.9.625c-.776-.292-1.663-.495-2.96-.555C15.656 0 15.244 0 12 0z"
    />
    <path
      fill="#E4405F"
      d="M12 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zm0 10.162a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 10-2.88 0 1.44 1.44 0 002.88 0z"
    />
  </svg>
);
